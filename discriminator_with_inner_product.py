...
from utils import non_local, global_sum_pooling, inner_product, dense
...
def discriminator_network():
  ...
  temp = inner_product(x, y, num_classes, None)
  inputs = dense("dense", x, 1, None, is_sn=True)
  result= temp + inputs
  ...
  model = Model(inputs=[input_image, y], outputs=result)
